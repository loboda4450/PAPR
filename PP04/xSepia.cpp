...
void xSepia_STD::testYUVtoRGBtoYUV_FLT(xPic &Dst, const xPic &Src) {
    ...
    __m128i SrcMidValueV_I32 = _mm_loadu_si128((__m128i*)(&SrcMidValue));
    __m128i DstMidValueV_I32 = _mm_loadu_si128((__m128i*)(&DstMidValue));
    __m128i DstMaxValueV_U16 = _mm_loadu_si128((__m128i*)(&DstMaxValue));
