  ...
  if(((uint32)Width & (uint32)c_RemainderMask8) == 0) //Width%8==0
  {
    for(int32 y = 0; y < Height; y++)
    {
      for(int32 x = 0; x < Width; x+=8)
      {
        ...
        __m128  SrcG0_F32 = _mm_add_ps(SrcLm0_F32, _mm_add_ps(_mm_mul_ps(SrcCb0_F32, _mm_set1_ps(YCbCr2RGB_F32[1][1])), _mm_mul_ps(SrcCr0_F32, _mm_set1_ps(YCbCr2RGB_F32[1][2]))));
        __m128  SrcG1_F32 = _mm_add_ps(SrcLm1_F32, _mm_add_ps(_mm_mul_ps(SrcCb1_F32, _mm_set1_ps(YCbCr2RGB_F32[1][1])), _mm_mul_ps(SrcCr1_F32, _mm_set1_ps(YCbCr2RGB_F32[1][2]))));
        ...
        //convert RGB --> YCbCr (BT.709)
        __m128  DstLm0_F32 = _mm_add_ps(_mm_mul_ps(DstR0_F32, _mm_set1_ps(RGB2YCbCr_F32[0][0])), _mm_add_ps(_mm_mul_ps(DstG0_F32, _mm_set1_ps(RGB2YCbCr_F32[0][1])), _mm_mul_ps(DstB0_F32, _mm_set1_ps(RGB2YCbCr_F32[0][2]))));
        __m128  DstLm1_F32 = _mm_add_ps(_mm_mul_ps(DstR1_F32, _mm_set1_ps(RGB2YCbCr_F32[0][0])), _mm_add_ps(_mm_mul_ps(DstG1_F32, _mm_set1_ps(RGB2YCbCr_F32[0][1])), _mm_mul_ps(DstB1_F32, _mm_set1_ps(RGB2YCbCr_F32[0][2]))));
        __m128  DstCb0_F32 = _mm_add_ps(_mm_mul_ps(DstR0_F32, _mm_set1_ps(RGB2YCbCr_F32[1][0])), _mm_add_ps(_mm_mul_ps(DstG0_F32, _mm_set1_ps(RGB2YCbCr_F32[1][1])), _mm_mul_ps(DstB0_F32, _mm_set1_ps(RGB2YCbCr_F32[1][2]))));
        __m128  DstCb1_F32 = _mm_add_ps(_mm_mul_ps(DstR1_F32, _mm_set1_ps(RGB2YCbCr_F32[1][0])), _mm_add_ps(_mm_mul_ps(DstG1_F32, _mm_set1_ps(RGB2YCbCr_F32[1][1])), _mm_mul_ps(DstB1_F32, _mm_set1_ps(RGB2YCbCr_F32[1][2]))));
        __m128  DstCr0_F32 = _mm_add_ps(_mm_mul_ps(DstR0_F32, _mm_set1_ps(RGB2YCbCr_F32[2][0])), _mm_add_ps(_mm_mul_ps(DstG0_F32, _mm_set1_ps(RGB2YCbCr_F32[2][1])), _mm_mul_ps(DstB0_F32, _mm_set1_ps(RGB2YCbCr_F32[2][2]))));
        __m128  DstCr1_F32 = _mm_add_ps(_mm_mul_ps(DstR1_F32, _mm_set1_ps(RGB2YCbCr_F32[2][0])), _mm_add_ps(_mm_mul_ps(DstG1_F32, _mm_set1_ps(RGB2YCbCr_F32[2][1])), _mm_mul_ps(DstB1_F32, _mm_set1_ps(RGB2YCbCr_F32[2][2]))));
    ...
    if (((uint32) Width & (uint32) c_RemainderMask8) == 0) //Width%8==0
    {
        for (int32 y = 0; y < Height; y++) {
            for (int32 x = 0; x < Width; x += 8) {
                ...
                //apply sepia effect
                __m128 DstR0_F32 = _mm_add_ps(_mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[0][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[0][1])),
                                                         _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[0][2]))));
                __m128 DstR1_F32 = _mm_add_ps(_mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[0][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[0][1])),
                                                         _mm_mul_ps(SrcB1_F32, _mm_set1_ps(SEPIA_F32[0][2]))));
                __m128 DstG0_F32 = _mm_add_ps(_mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[1][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[1][1])),
                                                         _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[1][2]))));
                __m128 DstG1_F32 = _mm_add_ps(_mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[1][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[1][1])),
                                                         _mm_mul_ps(SrcB1_F32, _mm_set1_ps(SEPIA_F32[1][2]))));
                __m128 DstB0_F32 = _mm_add_ps(_mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[2][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[2][1])),
                                                         _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[2][2]))));
                __m128 DstB1_F32 = _mm_add_ps(_mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[2][0])),
                                              _mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[2][1])),
                                                         _mm_mul_ps(SrcB1_F32, _mm_set1_ps(SEPIA_F32[2][2]))));
